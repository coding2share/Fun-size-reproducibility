...
##Overview
This is a brief reproduction of data analysis featured in a [tweet from APHA](https://twitter.com/AMJPublicHealth/status/900073839593349120) on August 22, 2017. In the tweet, APHA used data from [NHANES 2013-2014](https://wwwn.cdc.gov/nchs/nhanes/continuousnhanes/default.aspx?BeginYear=2013) to estimate the distribution of the hours spent sedentary by American adults (age 20 and over). 
